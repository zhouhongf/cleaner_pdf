...
def slug(hans, style=Style.NORMAL, heteronym=False, separator='-',
    ...
    ::
      ...
      'чжун1-го2-жэнь2'
    """
    return separator.join(chain(*pinyin(hans, style=style, heteronym=heteronym, errors=errors, strict=strict)))
...
def lazy_pinyin(hans, style=Style.NORMAL, errors='default', strict=True):
    ...
    Usage::
      ...
      ['чжун1', 'синь1']
    """
    return list(chain(*pinyin(hans, style=style, heteronym=False, errors=errors, strict=strict)))
